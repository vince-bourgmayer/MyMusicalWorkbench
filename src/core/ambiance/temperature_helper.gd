...
var annual_amplitude_high := 15.0 # max above mean (summer)
var annual_amplitude_low := 13.0  # max below mean (winter)
var daily_offset := -0.625
var daily_amplitude_high := 3.5
var daily_amplitude_low := 2.0
...
func _get_seasonal_variation(seasonal_factor: float):
	...
	if seasonal_factor >= 0:
		result = annual_amplitude_high * seasonal_factor
	else:
		result = annual_amplitude_low * seasonal_factor
	return result
...
func _get_daily_variation(daily_factor: float):
	var result : float
	if daily_factor >= 0:
		result = daily_amplitude_high * daily_factor
	else:
		result = daily_amplitude_low * daily_factor
	return result
...
func get_daily_noise(day: int) -> float:
	...
	return random_generator.randf_range(-0.75, 0.75)
